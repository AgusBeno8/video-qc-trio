...
Version 1.1 Notes: The 1.1 update of this repository adds a mock-up of a standard cloud workflow structure, utilizing S3-SQS buckets and notifications, Docker enviroments and the compose for their services, and lastly the usage of boto3 to manipulate the orchestration into coherence. The difference between this one process and a live AWS server one is the erasure of the localstack and the modification of the ports and directions. The automatization of video footage processing would occur with the same speed and efficiency.
